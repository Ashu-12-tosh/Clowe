    ...
    <div>
      <div className="flex items-center justify-between">
        ...
        <Link
          ...
          className="rounded-lg bg-ink-900 px-5 py-2 text-sm font-bold uppercase tracking-wide text-white hover:bg-ink-800"
        >
          + Add product
        </Link>
      </div>
          ...
          {items.map((p) => (
            ...
            >
              {p.imageUrl ? (
                ...
                <img src={p.imageUrl} alt="" className="h-16 w-12 rounded-lg bg-cream-100 object-cover" />
              ) : (
